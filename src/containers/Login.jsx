...
//         <Image className="form-container_img" src={logo} alt="logo" width="100%" height={'100%'} layout="responsive" />
//         <form className="form-container_form" action="/" ref={form}>
//           <label className="form-container_label" for="email-input">
//             Email address
//           </label>
//           <input className="form-container_input" name="email-input" type="text" />
//           <label className="form-container_label" for="password-input">
//             password
//           </label>
//           <input className="form-container_input" name="password-input" type="password" />
...
//           </a>
//         </p>
//         <input className="secondary-button" id="signup-button" type="button" value="sign up" />
//       </div>
//     </div>
//   );
// };
